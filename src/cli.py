...
def main():
    ...
    parser_train.add_argument("--epochs", type=int, default=hp.get("epochs", 30), help="Número de épocas")
    parser_train.add_argument("--batch", type=int, default=hp.get("batch_size", 512), help="Tamaño de batch")
    ...
    parser_tune.add_argument("--trials", type=int, default=5, help="Número de trials")
    parser_tune.add_argument("--timeout", type=int, default=1800, help="Timeout en segundos (default: 30 min)")
    ...
    parser_all.add_argument("--epochs", type=int, default=30, help="Número de épocas")
    parser_all.add_argument("--batch", type=int, default=512, help="Tamaño de batch")
    ...
    parser_all.add_argument("--trials", type=int, default=5, help="Número de trials de Optuna")
    parser_all.add_argument("--timeout", type=int, default=1800, help="Timeout de Optuna en segundos (default: 30 min)")
